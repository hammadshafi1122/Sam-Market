    ...
    <div className=' border-2 border-slate-800 space-y-2 md:my-[1rem] md:mx-[1.1rem]  lg:flex lg:border-none lg:py-[0rem] lg:my-[4rem] lg:px-[7rem] lg:space-x-10'>
        ...
        <div className='space-y-4 p-[1rem] lg:space-y-9'>
            ...
            <p>Lorem, ipsum sectetu
             ...
             <button className='border-2 border-gray-800 p-[0.5rem] font-bold lg:border-2 lg:border-gray-200 lg:p-[0.5rem]'>Shop Now</button>
        </div>
    </div>
    <div className='border-2 border-slate-800 space-y-2 md:my-[1rem] md:mx-[1.1rem]  lg:flex lg:border-none lg:py-[0rem] lg:my-[4rem] lg:px-[7rem] lg:space-x-10'>
        ...
        <div className='space-y-4 p-[1rem]  lg:space-y-9'>
            ...
            <p>Lorem, ipsum sectetu
             ...
             <button className='border-2 border-gray-800 p-[0.5rem] font-bold lg:border-2 lg:border-gray-5000 lg:p-[0.5rem]'>Shop Now</button>
        </div>
